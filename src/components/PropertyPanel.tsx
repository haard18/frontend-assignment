        ...
        return (
          <div className="flex gap-3">
            <input
              ...
              onChange={(e) => onPropertyChange(key, e.target.value)}
              className="w-12 h-11 border border-gray-200 rounded-lg cursor-pointer"
            />
            <input
              type="text"
      ...
      <div className="p-6 space-y-6">
        {properties.length === 0 ? (
          ...
          properties.map((property) => (
            <div key={property.key} className="space-y-3">
        ...
        <div className="mt-8 pt-6 border-t border-gray-100">
          <h4 className="text-sm font-semibold text-gray-800 mb-4">Quick Styles</h4>
